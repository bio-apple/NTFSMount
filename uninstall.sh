...
sudo /usr/bin/launchctl bootout system/com.bioapple.ntfsmount.helper >/dev/null 2>&1 || true
...
sudo rm -f /var/run/com.bioapple.ntfsmount.sock \
  /usr/local/sbin/ntfs-rw-helper /etc/sudoers.d/ntfs-rw \
