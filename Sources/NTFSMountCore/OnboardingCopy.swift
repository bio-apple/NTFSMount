...
public enum OnboardingCopy {
  ...
  public static func body(notarized: Bool) -> String {
    ...
    if !notarized {
      parts.append("""
      当前构建未公证。系统可能提示无法验证开发者：按住 Control 点应用 → 打开；也可在「系统设置 → 隐私与安全性」点「仍要打开」。自己用可以继续；作为产品发给别人请先公证。
      """)
    }
    parts.append("""
    1. 以可写方式挂载或格式化 NTFS 可能损坏数据。请先备份。
    2. 捆绑的 FUSE-T go-nfsv4 不是 GPL，默认仅供个人使用。作为产品分发或销售前，须向 FUSE-T 取得书面许可（https://www.fuse-t.org/）。
